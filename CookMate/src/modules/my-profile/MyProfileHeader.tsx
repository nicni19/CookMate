                ...
                <View style={styles.profileBannerContainer}>
                    <View style={styles.profileBanner}>
                        <View style={styles.profileBannerText}>
                            <Text style={styles.profileCookbookName}>
                                {this.props.cookbook?.name}
                            </Text>
                            <Text style={styles.profileCookbookFollowers}>
                                {this.getFollowerCountText(this.props.cookbook)}
                            </Text>
                        </View>
                    </View>
                    <Pressable
